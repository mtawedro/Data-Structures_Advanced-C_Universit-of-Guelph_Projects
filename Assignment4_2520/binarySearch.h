...
void addToTree(Tree * theTree, int data);
...
void removeFromTree(Tree * theTree, int data);
...
TreeDataPtr findInTree( Tree* theTree, int data );
...
TreeNode* FindMin(Tree * tree);

TreeNode* FindMax(Tree * tree);
